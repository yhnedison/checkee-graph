...
## Repository Description / GitHub 简介

**English:** Interactive Chrome extension for visualizing Checkee visa-clearance trends with weekly bar charts, time ranges, local caching, and controlled monthly data loading.

**中文：** 用于 Checkee 的交互式 Chrome 扩展，支持按周柱状图、时间范围筛选、本地缓存和限速月度数据拉取，帮助查看签证 clear 趋势。
